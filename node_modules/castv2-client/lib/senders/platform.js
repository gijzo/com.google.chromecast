...
function PlatformSender() {
	console.log('CONSTRUCTOR PlatformSender');
...
PlatformSender.prototype.connect = function(options, callback) {
  ...
  this.client.connect(options, function() {
    ...
    self.receiver   = self.createController(ReceiverController);
	  console.log('connected', Boolean(self.connection), Boolean(self.heartbeat), Boolean(self.receiver));
    ...
    function onclose() {
	    console.log('onClose', Boolean(self.connection), Boolean(self.heartbeat), Boolean(self.receiver));
      self.heartbeat.stop();
